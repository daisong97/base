...
public class DruidConfiguation {
	...
	/*
	 * @Bean public SqlSessionFactoryBean sqlSessionFactory(@Qualifier("dataSource")
	 * DataSource dataSource) { SqlSessionFactoryBean bean=new
	 * SqlSessionFactoryBean(); bean.setDataSource(dataSource); return bean; }
	 */
